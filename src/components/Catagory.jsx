...
const Category = ({ image, link, title, isLarge }) => {
    ...
    return (
        <div
            ...
            className={`category-container relative cursor-pointer border rounded-lg overflow-hidden shadow-md transition-all duration-300 mb-4 mt-2 ${isLarge ? 'w-full md:w-full lg:w-full xl:w-full' : 'w-full md:w-full lg:w-full xl:w-full'} sm:mx-4`}
        ...
        >
            <div className="relative w-full h-48 sm:h-64 md:h-72 lg:h-80 xl:h-96 overflow-hidden">
                <img
                    ...
                    style={{ minHeight: '100%', minWidth: '100%', maxHeight: '100%', maxWidth: '100%' }}
                />
            </div>
